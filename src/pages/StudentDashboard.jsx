...
export default function StudentDashboard({ onExit, onSelectModule }) {
  ...
  return (
    <main 
      className="page-background relative min-h-screen overflow-x-hidden bg-sky-700 bg-cover bg-center text-sky-950 font-sans selection:bg-sky-500 selection:text-white"
