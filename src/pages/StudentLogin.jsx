  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onBack}
        className="absolute left-5 top-5 z-20 flex h-11 w-11 items-center justify-center rounded-full border-2 border-white/70 bg-white/50 text-sky-950 shadow-lg backdrop-blur-md transition hover:-translate-x-1 hover:bg-white/70"
        aria-label="Kembali"
      >
        ...
        {submitted ? (
          <div className="flex min-h-[20rem] flex-col items-center justify-center">
            ...
            <button
              type="button"
              onClick={onBack}
              className="mt-7 rounded-full bg-gradient-to-b from-yellow-300 to-amber-400 px-8 py-3 font-black text-amber-950 shadow-lg transition hover:scale-105"
            >
              Selesai
            </button>
          </div>
          ...
          <>
            <div
              className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-yellow-200 to-amber-400 text-3xl shadow-lg"
              aria-hidden="true"
            >
              ★
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-7 space-y-5 text-left">
              <label className="block">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border-2 border-amber-200 bg-white/90 px-5 py-3.5 font-bold text-sky-950 outline-none transition placeholder:text-slate-400 focus:border-sky-400 focus:ring-4 focus:ring-sky-200/60"
                />
              </label>
              <label className="block">
              ...
              {error && (
                <p role="alert" className="rounded-xl bg-red-100 px-4 py-3 text-center text-sm font-bold text-red-700">
                  {error}
                </p>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex w-full items-center justify-center rounded-full bg-gradient-to-b from-yellow-300 to-amber-400 py-3.5 font-brand text-xl font-black text-amber-950 shadow-lg transition hover:scale-[1.02] disabled:cursor-wait disabled:opacity-70"
              >
